...
public class VAlquiler extends JFrame {
    ...
    JTextArea A1 = new JTextArea("09H00 a 22H00");
    ...
    private void agregarComponentes() {
        ...
        op.gridx = 2;
        op.gridy = 1;
        panel.add(new JButton("5 minutos mas"), op);
        ...
        op.gridx = 0;
        op.gridy = 1;
        panel.add(new JLabel("Hora Atención"), op);
        ...
        op.gridx = 0;
        op.gridy = 3;
        panel.add(new JLabel("Hora de salida"), op);
        op.gridx = 1;
        op.gridy = 3;
        panel.add(tf5, op);
        op.gridx = 2;
        ...
        op.gridx = 2;
        op.gridy = 3;
        panel.add(new JButton("Falta Cancelar"), op);
        op.gridy = 3;
        op.gridx = 3;
